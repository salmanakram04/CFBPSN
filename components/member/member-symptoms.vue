<template>
  <div class="container p-4">
    ...
    <div class="border w-100 p-3 bg-white">
      <p>
        <span class="text-info font-weight-bold">750000+</span> patients with
        <span class="text-info font-weight-bold">2,800+</span> conditions are sharing about their symptoms and how they manage them. See what they’re saying about yours…
      </p>
      <div class="mb-4">
